...
{
    public partial class frmIzdatniceIzDokumenata : Form
    {
        ...
        public frmIzdatniceIzDokumenata(string transport,string osnova,string skladistar,string partneri,string id_skladistara,string id_partnera,string id_dok)
        {
            InitializeComponent();

            txtNacinDopreme.Text = transport;
            cmbOsnova.Text = osnova;
            btnUnosIzdatnice.Hide();
        ...
        private void btnUnosStavki_Click_1(object sender, EventArgs e)
        {
            if (txtKolicina.Text == "")
            {
            ...
            else
            {
                ...
                using (var db = new T02_DBEntities())
                {
                    ...
                    if (brojacGumba < 2)
                    {
                        btnUnosIzdatnice_Click(sender, e);
                    }
                    ...
                    if (int.Parse(txtKolicina.Text) <= kolicina && int.Parse(txtMasa.Text) <= masaa)
                    {
                        ...
                        int idArtiklaParam = idArtikla;
                        int kolicinaZaOtpremuParam = int.Parse(txtKolicina.Text);
                        int masaZaOtpremuParam = int.Parse(txtMasa.Text);
