...
{
    public partial class frmPrimkeIzDokumenata : Form
    {
        ...
        public frmPrimkeIzDokumenata(string transport,string osnova,string skladistar,string partneri,string id_skladistara,string id_partnera,string id_dok)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                using (var db = new T02_DBEntities())
                {
                    ...
                    if (int.Parse(txtKolicina.Text) <= kolicina && int.Parse(txtMasa.Text) <= masaa)
                    {
                        ...
                        MessageBox.Show("Primka je unesena!");
